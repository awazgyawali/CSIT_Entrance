...
public class YearsList extends Fragment {
    ...
    private void prepareModelQuestion() {
        ...
        YearItem item18 = new YearItem();
        item18.setType(YearItem.Companion.getYEAR_SET());
        item18.setTitle("Model Paper 12");
        item18.setPaperCode(19);
        items.add(item18);

        YearItem item19 = new YearItem();
        item19.setType(YearItem.Companion.getYEAR_SET());
        item19.setTitle("Model Paper 13");
        item19.setPaperCode(21);
        items.add(item19);

        YearItem item20 = new YearItem();
        item20.setType(YearItem.Companion.getYEAR_SET());
