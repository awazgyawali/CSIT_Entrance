...
public class FullQuestionAdapter extends RecyclerView.Adapter<FullQuestionAdapter.ViewHolder> {
    ...
    public FullQuestionAdapter(Context context, int code) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        String htm = questions.get(position) + "<br>"
                + "a) " + a.get(position) + "<br>"
                + "b) " + b.get(position) + "<br>"
                + "c) " + c.get(position) + "<br>"
                + "d) " + d.get(position) + "<br>"
                + "<b>Answer:</b> " + answer.get(position);
